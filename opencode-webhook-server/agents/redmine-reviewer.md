...
- [ ] Process review outcome → determine Case A or Case B
- [ ] Create bug subtask via redmine_redmine_create_issue (if Case A)
- [ ] Update parent issue status via redmine_redmine_update_issue
